 ...
 */
export { intersect as stdIntersect } from "https://deno.land/std@0.203.0/collections/intersect.ts";
export * as stdFS from "https://deno.land/std@0.203.0/fs/mod.ts";
export * as stdLog from "https://deno.land/std@0.203.0/log/mod.ts";
export type {
	FormatterFunction,
	Logger,
	LogRecord,
...
export * as stdSemver from "https://deno.land/std@0.203.0/semver/mod.ts";
